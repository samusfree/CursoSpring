...
<body>
	...
	<form action="modificarCuenta" method="post">
		...
		<br /> 
		¿Pago? 
		<input type="checkbox" name="pago" ${cuenta.pago?'checked':''} /> 
		<br /> 
		Fecha de Pago: 
		<input type="text" name="fechaPago" value="<fmt:formatDate value="${cuenta.fechaPago.time}" pattern="dd/MM/yyyy" />" />
		<br /> 
